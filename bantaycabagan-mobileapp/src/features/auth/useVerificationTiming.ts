...
import { deadlineRemaining, formatCountdown, type Timing } from './verificationFeedback'

export function useVerificationTiming(challenge: Timing | null, retry: Timing | null) {
